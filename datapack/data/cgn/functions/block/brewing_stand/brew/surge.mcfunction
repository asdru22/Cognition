...
data modify storage srn:storage root.temp.item.tag.srn set value {id:"potion",potion:{id:"cgn:surge"}}
# effects
...
execute if data storage srn:storage root.temp.item{id:"minecraft:splash_potion"} run data modify storage srn:storage root.temp.item.tag.display.Lore set value ['""','{"color":"dark_purple","italic":false,"translate":"potion.whenDrank"}','{"color":"blue","italic":false,"translate":"attribute.modifier.plus.0","with":[1,{"translate":"item.cgn.electroplasm"}]}']
...
execute if data storage srn:storage root.temp.item{id:"minecraft:lingering_potion"} run data modify storage srn:storage root.temp.item.tag.display.Lore set value ['""','{"color":"dark_purple","italic":false,"translate":"potion.whenDrank"}','{"color":"blue","italic":false,"translate":"attribute.modifier.plus.0","with":[0.2,{"translate":"item.cgn.electroplasm"}]}']
...
execute as @e[type=!#srn:inanimate,predicate=cgn:entity/electroplasm_wave_can_hit,distance=..10,dx=0] positioned ~-0.6 ~-0.6 ~-0.6 if entity @s[dx=0] positioned ~0.6 ~0.6 ~0.6 run function cgn:item/electroplasm_carver/projectile/hit/main

...
execute store result score $quick_charge cgn.dummy run data get storage cgn:storage root.temp.item.components."minecraft:enchantments".levels."minecraft:quick_charge" 5

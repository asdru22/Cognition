...
execute unless score #temp cgn.dummy matches 36 run function srn:technical/macros/loot/give with storage srn:storage root.temp.item
execute if score #temp cgn.dummy matches 36 run function srn:technical/macros/loot/spawn with storage srn:storage root.temp.item
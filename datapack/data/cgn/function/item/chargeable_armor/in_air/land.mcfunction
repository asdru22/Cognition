...
attribute @s generic.gravity modifier remove cgn:chargeable_armor.gravity
attribute @s generic.safe_fall_distance modifier remove cgn:chargeable_armor.safe_fall_distance

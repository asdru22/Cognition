...
execute if entity @s[predicate=cgn:entity_properties/sneaking,tag=!cgn.chargeable_armor.launch,nbt=!{FallDistance:0.0f}] run function cgn:item/chargeable_armor/in_air/launch_player

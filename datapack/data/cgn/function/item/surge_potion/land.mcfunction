...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @n[type=item_display,tag=cgn.block.greek_fire,dx=0] at @s run function cgn:block/greek_fire/make_pyroplasm with storage cgn:macro root

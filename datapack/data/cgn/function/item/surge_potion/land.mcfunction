...
execute positioned ~-0.8 ~-0.8 ~-0.8 as @n[type=item_display,tag=cgn.greek_fire,dx=0] at @s run function cgn:block/greek_fire/pyroplasm/make with storage cgn:macro root

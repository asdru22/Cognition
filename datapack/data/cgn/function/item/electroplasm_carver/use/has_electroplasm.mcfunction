...
execute anchored feet rotated ~ 0 positioned ~ ~.2 ~ summon item_display run function cgn:item/electroplasm_carver/projectile/init with storage cgn:storage root.temp

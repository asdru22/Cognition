execute if entity @s[tag=cgn.smoldering_vortex] run return run function cgn:block/smoldering_vortex/tick

execute if entity @s[tag=cgn.guster] run return run function cgn:block/guster/tick

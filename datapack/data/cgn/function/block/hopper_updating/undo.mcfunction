...
execute as @e[type=minecraft:item_display,tag=cgn.prevents_hoppers,tag=cgn.block,distance=..5] at @s positioned ~ ~-1 ~ run function cgn:block/hopper_updating/fill
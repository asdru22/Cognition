...
execute as @e[type=minecraft:item_display,tag=tcc.prevents_hoppers,tag=tcc.block,distance=..5] at @s positioned ~ ~-1 ~ run function cgn:block/hopper_updating/fill
...
# effects
execute if data storage cgn:storage root.temp.item{id:"minecraft:potion"} run data modify storage cgn:storage root.temp.item.components."minecraft:item_name" set value '{"translate":"item.cgn.potion.effect.surge","italic":false}'
...
execute if data storage cgn:storage root.temp.item{id:"minecraft:splash_potion"} run data modify storage cgn:storage root.temp.item.components."minecraft:item_name" set value '{"translate":"item.cgn.splash_potion.effect.surge","italic":false}'
execute if data storage cgn:storage root.temp.item{id:"minecraft:splash_potion"} run data modify storage cgn:storage root.temp.item.components."minecraft:lore" set value ['""','{"color":"dark_purple","italic":false,"translate":"potion.whenDrank"}','{"color":"blue","italic":false,"translate":"attribute.modifier.plus.0","with":[1,{"translate":"item.cgn.electroplasm"}]}']

execute if data storage cgn:storage root.temp.item{id:"minecraft:lingering_potion"} run data modify storage cgn:storage root.temp.item.components."minecraft:item_name" set value '{"translate":"item.cgn.lingering_potion.effect.surge","italic":false}'
execute if data storage cgn:storage root.temp.item{id:"minecraft:lingering_potion"} run data modify storage cgn:storage root.temp.item.components.display."minecraft:lore" set value ['""','{"color":"dark_purple","italic":false,"translate":"potion.whenDrank"}','{"color":"blue","italic":false,"translate":"attribute.modifier.plus.0","with":[0.2,{"translate":"item.cgn.electroplasm"}]}']
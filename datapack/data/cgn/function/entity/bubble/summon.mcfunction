$data merge entity @s {billboard:"center",teleport_duration:1,Tags:["cgn.tick","cgn.bubble","cgn.setup","cgn.bubble.$(bubble)","smithed.strict"],item:{id:"warped_fungus_on_a_stick",count:1,components:{custom_model_data:$(cmd)}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]}}

...
execute if entity @s[scores={cgn.dummy=200..}] run function cgn:entity/bubble/pop {src:"time"}
...
execute positioned ~-1.5 ~-1.5 ~-1.5 as @n[type=!#cgn:can_enter_bubble,tag=!smithed.strict,dx=2,dz=2,dy=2] run say @s 
execute positioned ~-1.5 ~-1.5 ~-1.5 as @n[type=!#cgn:can_enter_bubble,tag=!smithed.strict,dx=2,dz=2,dy=2] run tellraw @p {"nbt":"{}","entity":"@s"}

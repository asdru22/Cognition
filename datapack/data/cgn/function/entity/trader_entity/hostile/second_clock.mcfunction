...
execute if entity @s[tag=!cgn.attacking] if entity @n[predicate=cgn:entity_properties/hostile_target,distance=..16] run function cgn:entity/trader_entity/hostile/line_of_sight

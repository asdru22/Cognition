...
execute if entity @s[tag=cgn.ebonite_sword_interaction] on vehicle if entity @s[tag=!cgn.double_edged_sword.punched] run function cgn:item/double_edged_sword/punch/init

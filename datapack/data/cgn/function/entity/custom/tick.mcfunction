...
execute if score @s cgn.animation_timer matches ..2 run function cgn:entity/custom/states/dead/kill with entity @s ArmorItems[3].components."minecraft:custom_data".cgn
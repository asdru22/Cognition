...
data modify storage cgn:storage root.temp.player.old_name set from storage cgn:storage root.temp.player.name
execute store result score #match cgn.dummy run data modify storage cgn:storage root.temp.player.old_name set from storage cgn:storage root.temp.t_player.name
